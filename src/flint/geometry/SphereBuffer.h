...
public:
    ...
    static SphereBuffer Create(const Sphere<3, T> &sphere, unsigned int subdivisions) {
        ...
        static const VertexList<Eigen::Array<T, 3, 1>> kVertices = {
            { -X,N,Z },{ X,N,Z },{ -X,N,-Z },{ X,N,-Z },
            { N,Z,X },{ N,Z,-X },{ N,-Z,X },{ N,-Z,-X },
            { Z,X,N },{ -Z,X, N },{ Z,-X,N },{ -Z,-X, N }
        };

        static const TriangleList kTriangles = {
        ...
        VertexList<Eigen::Array<T, 3, 1>> vertices = kVertices;
        TriangleList triangles = kTriangles;
        VertexList<Eigen::Array<T, 3, 1>> nextVertices;
        TriangleList nextTriangles;
